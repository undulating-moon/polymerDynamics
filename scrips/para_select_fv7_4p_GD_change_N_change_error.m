...
for error_step_number=1:N_simulation
    disp(['------error_N:step',num2str(error_step_number),'--------'])
...
error=((sumR_square-sumR^2/N_simulation)/(N_simulation*(N_simulation-1)))^0.5;
sqrN_error=(Total_experiment_number)^0.5*error*(N_simulation)*0.5
%% storage system
...
%            parameter_history=parameter_history(1:end-1,:);
